...
void GT_RGB2HSL(CGFloat r, CGFloat g, CGFloat b,
...
void GT_HSL2RGB(CGFloat h, CGFloat s, CGFloat l,
...
void GT_RGB2HSB(CGFloat r, CGFloat g, CGFloat b,
...
void GT_HSB2RGB(CGFloat h, CGFloat s, CGFloat v,
                CGFloat *r, CGFloat *g, CGFloat *b) {
    CLAMP_COLOR_VALUE(h);
    CLAMP_COLOR_VALUE(s);
    CLAMP_COLOR_VALUE(v);
...
void GT_RGB2CMYK(CGFloat r, CGFloat g, CGFloat b,
...
void GT_CMYK2RGB(CGFloat c, CGFloat m, CGFloat y, CGFloat k,
                 CGFloat *r, CGFloat *g, CGFloat *b) {
    CLAMP_COLOR_VALUE(c);
    CLAMP_COLOR_VALUE(m);
    CLAMP_COLOR_VALUE(y);
...
void GT_HSB2HSL(CGFloat h, CGFloat s, CGFloat b,
...
void GT_HSL2HSB(CGFloat h, CGFloat s, CGFloat l,
...
@implementation UIColor (GTKit)

+ (UIColor *)gt_colorWithHue:(CGFloat)hue
               saturation:(CGFloat)saturation
                lightness:(CGFloat)lightness
                    alpha:(CGFloat)alpha {
    CGFloat r, g, b;
    GT_HSL2RGB(hue, saturation, lightness, &r, &g, &b);
    return [UIColor colorWithRed:r green:g blue:b alpha:alpha];
}
+ (UIColor *)gt_colorWithCyan:(CGFloat)cyan
                   magenta:(CGFloat)magenta
                    yellow:(CGFloat)yellow
                     black:(CGFloat)black
                     alpha:(CGFloat)alpha {
    CGFloat r, g, b;
    GT_CMYK2RGB(cyan, magenta, yellow, black, &r, &g, &b);
    return [UIColor colorWithRed:r green:g blue:b alpha:alpha];
}

+ (UIColor *)gt_colorWithRGB:(uint32_t)rgbValue {
...
+ (UIColor *)gt_colorWithRGBA:(uint32_t)rgbaValue {
...
+ (UIColor *)gt_colorWithRGB:(uint32_t)rgbValue alpha:(CGFloat)alpha {
    return [UIColor colorWithRed:((rgbValue & 0xFF0000) >> 16) / 255.0f
                           green:((rgbValue & 0xFF00) >> 8) / 255.0f
                            blue:(rgbValue & 0xFF) / 255.0f
                           alpha:alpha];
...
static BOOL hexStrToRGBA(NSString *str,
    ...
    str = [[str gt_stringByTrim] uppercaseString];
    if ([str hasPrefix:@"#"]) {
...
+ (instancetype)gt_colorWithHexString:(NSString *)hexStr {
    CGFloat r, g, b, a;
...
- (NSString *)gt_hexString {
    return [self gt_hexStringWithAlpha:NO];
}

- (NSString *)gt_hexStringWithAlpha {
    return [self gt_hexStringWithAlpha:YES];
}

- (NSString *)gt_hexStringWithAlpha:(BOOL)withAlpha {
    ...
    if (hex && withAlpha) {
        hex = [hex stringByAppendingFormat:@"%02lx",
               (unsigned long)(self.gt_alpha * 255.0 + 0.5)];
    }
    return hex;
}

- (UIColor *)gt_colorByAddColor:(UIColor *)add blendMode:(CGBlendMode)blendMode {
    CGColorSpaceRef colorSpace = CGColorSpaceCreateDeviceRGB();
...
- (UIColor *)gt_colorByChangeHue:(CGFloat)h saturation:(CGFloat)s brightness:(CGFloat)b alpha:(CGFloat)a {
    CGFloat hh, ss, bb, aa;
...
- (BOOL)gt_getHue:(CGFloat *)hue
    ...
    GT_RGB2HSL(r, g, b, hue, saturation, lightness);
    *alpha = a;
    return YES;
}

- (BOOL)gt_getCyan:(CGFloat *)cyan
        magenta:(CGFloat *)magenta
         yellow:(CGFloat *)yellow
          black:(CGFloat *)black
          alpha:(CGFloat *)alpha {
    ...
    GT_RGB2CMYK(r, g, b, cyan, magenta, yellow, black);
    *alpha = a;
    return YES;
}
...
- (CGFloat)gt_saturation {
    CGFloat h, s = 0, b, a;
    [self getHue:&h saturation:&s brightness:&b alpha:&a];
    return s;
}

- (CGFloat)gt_brightness {
    CGFloat h, s, b = 0, a;
    [self getHue:&h saturation:&s brightness:&b alpha:&a];
    return b;
}

- (CGColorSpaceModel)gt_colorSpaceModel {
    return CGColorSpaceGetModel(CGColorGetColorSpace(self.CGColor));
}

- (NSString *)gt_colorSpaceString {
