...
/** The pan gestures that handles the view dragging
 gt_panGesture The tint color of the blurred view. Set to nil to reset.
 */
@property (nonatomic) UIPanGestureRecognizer *gt_panGesture;
 ...
 */
@property (nonatomic) CGRect gt_cagingArea;
 ...
 */
@property (nonatomic) CGRect gt_handle;

/**
 Restricts the movement along the X axis
 */
@property (nonatomic) BOOL gt_shouldMoveAlongX;

/**
 Restricts the movement along the Y axis
 */
@property (nonatomic) BOOL gt_shouldMoveAlongY;

/**
 Notifies when dragging started
 */
@property (nonatomic, copy) void (^gt_draggingStartedBlock)(void);

/**
 Notifies when dragging ended
 */
@property (nonatomic, copy) void (^gt_draggingEndedBlock)(void);
