 ...
 */
@interface NSArray<__covariant ObjectType> (GTKit)
 ...
 */
+ (nullable NSArray *)gt_arrayWithPlistData:(NSData *)plist;
 ...
 */
+ (nullable NSArray *)gt_arrayWithPlistString:(NSString *)plist;
 ...
 */
- (nullable ObjectType)gt_randomObject;
 ...
 */
- (nullable ObjectType)gt_objectOrNilAtIndex:(NSUInteger)index;
 ...
 */
@interface NSMutableArray<ObjectType>  (GTKit)
...
/**
 ...
 @return A new array created from the binary plist data, or nil if an error occurs.
 */
+ (nullable NSMutableArray *)gt_arrayWithPlistData:(NSData *)plist;
...
/**
 ...
 @return A new array created from the plist string, or nil if an error occurs.
 */
+ (nullable NSMutableArray *)gt_arrayWithPlistString:(NSString *)plist;
 ...
 */
- (nullable ObjectType)gt_popFirstObject;
...
/**
 ...
 @return The first object, or nil.
 */
- (nullable ObjectType)gt_popLastObject;
 ...
 */
- (void)gt_appendObject:(id)anObject;
...
/**
 ...
 This value must not be nil. Raises an NSInvalidArgumentException if anObject is nil.
 */
- (void)gt_prependObject:(id)anObject;
 ...
 */
- (void)gt_appendObjects:(NSArray *)objects;
...
/**
 ...
 content. If the objects is empty or nil, this method has no effect.
 */
- (void)gt_prependObjects:(NSArray *)objects;
 ...
 */
- (void)gt_insertObjects:(NSArray *)objects atIndex:(NSUInteger)index;
