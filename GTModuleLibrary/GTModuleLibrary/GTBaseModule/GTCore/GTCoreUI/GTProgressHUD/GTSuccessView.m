...
- (void)setGt_animationType:(GTAnimationType)gt_animationType
{
    _gt_animationType = gt_animationType;
...
- (void)drawSuccessErrorLine{
    ...
    if (_gt_animationType == GTAnimationTypeSuccess) {
    ...
    } else if (_gt_animationType == GTAnimationTypeError) {
