...
+ (id)loadingViewStyleCircleWithFrame:(CGRect)frame{
    ...
    GTLoadingView *loadingView = [[GTLoadingView alloc]initWithFrame:frame LoadingViewStyle:LoadingViewStyleCircle];
...
+ (id)loadingViewStyleNoDataWithFrame:(CGRect)frame AddTarget:(id)target action:(SEL)action{
    ...
    GTLoadingView *loadingView = [[GTLoadingView alloc]initWithFrame:frame LoadingViewStyle:LoadingViewStyleNoData AddTarget:target action:action];
...
+ (id)loadingViewStyleTitleWithFrame:(CGRect)frame{
    ...
    GTLoadingView *loadingView = [[GTLoadingView alloc]initWithFrame:frame LoadingViewStyle:LoadingViewStyleTitle];
...
+ (id)loadingViewStyleCustomWithFrame:(CGRect)frame{
    ...
    GTLoadingView *loadingView = [[GTLoadingView alloc]initWithFrame:frame LoadingViewStyle:LoadingViewStyleCustom];
...
+ (id)loadingViewStyleProgressWithFrame:(CGRect)frame{
    ...
    GTLoadingView *loadingView = [[GTLoadingView alloc]initWithFrame:frame LoadingViewStyle:LoadingViewStyleProgress];
...
+ (id)loadingViewStylePromptBarWithFrame:(CGRect)frame{
    ...
    GTLoadingView *loadingView = [[GTLoadingView alloc]initWithFrame:frame LoadingViewStyle:LoadingViewStylePromptBar];
