...
- (instancetype)initWithProgressIndicatorStyle:(GTProgressIndicatorStyle)style {
    ...
    switch (style) {
        ...
        case 0:self =  [self initWithFrame:CGRectMake(0, 0, WIDTH_NORMAL, HEIGHT_NORMAL)];
            ...
            self.progressIndicatorStyle = GTProgressIndicatorStyleNormal;

            break;

        case 1: self = [self initWithFrame:CGRectMake(0, 0, WIDTH_BIG, HEIGHT_BIG)];

            self.progressIndicatorStyle = GTProgressIndicatorStyleLarge;
...
- (void)setProgressIndicatorStyle:(GTProgressIndicatorStyle)progressIndicatorStyle {
