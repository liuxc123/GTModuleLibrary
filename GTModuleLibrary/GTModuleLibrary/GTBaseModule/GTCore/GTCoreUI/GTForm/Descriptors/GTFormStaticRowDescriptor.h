...
/** 选中背景颜色 **/
@property (nonatomic, strong) UIColor * _Nullable selectBackgroundColor;
...
/** 默认黑色 */
@property (nonatomic, strong) UIColor * _Nullable iconBorderColor;
/** 默认0.5 */
...
/** 箭头的图片 */
@property (nonatomic, strong) UIImage * _Nullable arrowImage;
...
@property (nonatomic, strong) UIFont * _Nullable detailTextFont;
/** 设置文字颜色 */
...
/** switch类型点击开关回调 */
@property (nonatomic, copy) void(^ _Nullable switchChangeBlock)(BOOL open);


+ (instancetype _Nullable )formStaticRowDescriptorWithTag:(NSString *_Nullable)tag title:(NSString *_Nullable)title staticStyle:(GTFormStaticType)staticStyle;

+ (instancetype _Nullable )formStaticRowDescriptorWithTag:(NSString *_Nullable)tag title:(NSString *_Nullable)title detailTitle:(NSString *_Nullable)detailTitle staticStyle:(GTFormStaticType)staticStyle;

+ (instancetype _Nullable )formStaticRowDescriptorWithTag:(NSString *_Nullable)tag title:(NSString *_Nullable)title icon:(NSString *_Nullable)icon staticStyle:(GTFormStaticType)staticStyle;

+ (instancetype _Nullable )formStaticRowDescriptorWithTag:(NSString *_Nullable)tag title:(NSString *_Nullable)title detailTitle:(NSString *_Nullable)detailTitle icon:(NSString *_Nullable)icon staticStyle:(GTFormStaticType)staticStyle;
