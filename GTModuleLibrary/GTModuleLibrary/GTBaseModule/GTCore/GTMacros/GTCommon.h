...
//static inline void GTAssertNil(bool condition, NSString *description, ...) {
//    NSAssert(!(condition), (description), __VA_ARGS__);
//}

static inline void GTAssertMainThread() {
    NSCAssert([NSThread isMainThread], @"This method must be called on the main thread");
}

static inline void GTCAssertMainThread() {
    NSCAssert([NSThread isMainThread], @"This method must be called on the main thread");
}
 ...
 *******************************************************************************
 Example:
 GTSYNTH_DUMMY_CLASS(NSString_GTAdd)
 */
#ifndef GTSYNTH_DUMMY_CLASS
#define GTSYNTH_DUMMY_CLASS(_name_) \
@interface GTSYNTH_DUMMY_CLASS_ ## _name_ : NSObject @end \
@implementation GTSYNTH_DUMMY_CLASS_ ## _name_ @end
#endif
 ...
 *  @return 是否成功替换（或增加）
 */
static inline bool ExchangeImplementationsInTwoClasses(Class _fromClass, SEL _originSelector, Class _toClass, SEL _newSelector) {
 ...
 */
static inline bool OverrideImplementation(Class targetClass, SEL targetSelector, id (^implementationBlock)(Class originClass, SEL originCMD, IMP originIMP)) {
 ...
 */
static inline BOOL ExtendImplementationOfVoidMethodWithoutArguments(Class targetClass, SEL targetSelector, void (^implementationBlock)(__kindof NSObject *selfObject)) {
 ...
 */
static inline NSRange GTNSRangeFromCFRange(CFRange range) {
 ...
 */
static inline CFRange GTCFRangeFromNSRange(NSRange range) {
 ...
 */
static inline CFTypeRef GTCFAutorelease(CFTypeRef CF_RELEASES_ARGUMENT arg) {
 ...
 */
static inline void GTBenchmark(void (^block)(void), void (^complete)(double ms)) {
...
static inline NSDate *_GTCompileTime(const char *data, const char *time) {
