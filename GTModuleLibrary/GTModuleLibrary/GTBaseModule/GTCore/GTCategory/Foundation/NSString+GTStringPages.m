...
@implementation NSString (GTStringPages)

- (NSArray *)gt_getPagesOfString:(NSString *)cache
...
#pragma clang diagnostic pop
    ...
    NSLog(@"Max Line Per Page: %ld (%.2f/%.2f)", (long)maxLine, rect.size.height, lineHeight);
