...
- (NSString *)gt_hmacStringUsingAlg:(CCHmacAlgorithm)alg withKey:(NSString *)key {
    size_t size;
    switch (alg) {
...
- (NSData *)gt_hmacDataUsingAlg:(CCHmacAlgorithm)alg withKey:(NSData *)key {
    size_t size;
    switch (alg) {
        case kCCHmacAlgMD5: size = CC_MD5_DIGEST_LENGTH; break;
        case kCCHmacAlgSHA1: size = CC_SHA1_DIGEST_LENGTH; break;
...
- (NSString *)gt_hmacMD5StringWithKey:(NSString *)key {
    return [self gt_hmacStringUsingAlg:kCCHmacAlgMD5 withKey:key];
}

- (NSData *)gt_hmacMD5DataWithKey:(NSData *)key {
    return [self gt_hmacDataUsingAlg:kCCHmacAlgMD5 withKey:key];
}

- (NSString *)gt_hmacSHA1StringWithKey:(NSString *)key {
    return [self gt_hmacStringUsingAlg:kCCHmacAlgSHA1 withKey:key];
}

- (NSData *)gt_hmacSHA1DataWithKey:(NSData *)key {
    return [self gt_hmacDataUsingAlg:kCCHmacAlgSHA1 withKey:key];
}

- (NSString *)gt_hmacSHA224StringWithKey:(NSString *)key {
    return [self gt_hmacStringUsingAlg:kCCHmacAlgSHA224 withKey:key];
}

- (NSData *)gt_hmacSHA224DataWithKey:(NSData *)key {
    return [self gt_hmacDataUsingAlg:kCCHmacAlgSHA224 withKey:key];
}

- (NSString *)gt_hmacSHA256StringWithKey:(NSString *)key {
    return [self gt_hmacStringUsingAlg:kCCHmacAlgSHA256 withKey:key];
}

- (NSData *)gt_hmacSHA256DataWithKey:(NSData *)key {
    return [self gt_hmacDataUsingAlg:kCCHmacAlgSHA256 withKey:key];
}

- (NSString *)gt_hmacSHA384StringWithKey:(NSString *)key {
    return [self gt_hmacStringUsingAlg:kCCHmacAlgSHA384 withKey:key];
}

- (NSData *)gt_hmacSHA384DataWithKey:(NSData *)key {
    return [self gt_hmacDataUsingAlg:kCCHmacAlgSHA384 withKey:key];
}

- (NSString *)gt_hmacSHA512StringWithKey:(NSString *)key {
    return [self gt_hmacStringUsingAlg:kCCHmacAlgSHA512 withKey:key];
}

- (NSData *)gt_hmacSHA512DataWithKey:(NSData *)key {
    return [self gt_hmacDataUsingAlg:kCCHmacAlgSHA512 withKey:key];
}
...
- (NSData *)gt_aes256EncryptWithKey:(NSData *)key iv:(NSData *)iv {
...
- (NSData *)gt_aes256DecryptWithkey:(NSData *)key iv:(NSData *)iv {
    if (key.length != 16 && key.length != 24 && key.length != 32) {
        return nil;
    }
    if (iv.length != 16 && iv.length != 0) {
...
+ (NSData *)gt_dataWithHexString:(NSString *)hexStr {
...
+ (NSData *)gt_dataWithBase64EncodedString:(NSString *)base64EncodedString {
...
+ (NSData *)gt_dataNamed:(NSString *)name {
