...
/**
 ...
 action message is sent.
 */
- (void)gt_addBlockForControlEvents:(UIControlEvents)controlEvents block:(void (^)(id sender))block;
...
/**
 ...
 action message is sent.
 */
- (void)gt_setBlockForControlEvents:(UIControlEvents)controlEvents block:(void (^)(id sender))block;
