...
@implementation UIView (GTAnimation)
                              ...
                              finishBlock:(void(^)(void))finishBlock
{
    ...
    switch (positionType) {
        case GTViewAnimationEnterDirectionTypeTop:
        {
            // From
            ...
            break;
        case GTViewAnimationEnterDirectionTypeLeft:
        {
            // From
            ...
            break;
        case GTViewAnimationEnterDirectionTypeBottom:
        {
            // From
            ...
            break;
        case GTViewAnimationEnterDirectionTypeRitht:
        {
            // From
...
- (void)gt_view_showFromScreenBottom
{
                            ...
                            direction:(GTViewAnimationFlipDirectionType)direction
{
    ...
    switch(direction)
    {
        case GTViewAnimationFlipDirectionTypeTop:
            subtype = @"fromTop";
            break;
        case GTViewAnimationFlipDirectionTypeLeft:
            subtype = @"fromLeft";
            break;
        case GTViewAnimationFlipDirectionTypeBottom:
            subtype = @"fromBottom";
            break;
        case GTViewAnimationFlipDirectionTypeRight:
        default:
            subtype = @"fromRight";
            break;
    }
        ...
        if(finished)
        {
            [UIView animateWithDuration:duration / 2 delay:0.5f options:UIViewAnimationOptionCurveEaseInOut animations:^{
                ...
                if(finished)
                {
                    if(repeat)
                    {
                        [self gt_animation_translateAroundTheView:topView duration:duration direction:direction repeat:repeat startFromEdge:startFromEdge];
                    }
                }
            }];
        }
...
{
    [self.layer gt_layer_animationShakeWithValue:6.0f repeatCount:5.0f];
}
...
/**
 ...
 @param duration duration
 */
- (void)gt_animation_heartbeatViewWithDuration:(CGFloat)duration
{
