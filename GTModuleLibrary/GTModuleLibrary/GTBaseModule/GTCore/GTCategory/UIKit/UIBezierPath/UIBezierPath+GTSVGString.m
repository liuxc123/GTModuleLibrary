...
static void GTSVGApplier(void* info, const CGPathElement* element);
@implementation UIBezierPath (GTSVGString)
/**
...
- (NSString*)gt_SVGString
{
    ...
    CGPathApply(path, (__bridge_retained void*)SVGString, GTSVGApplier);
    NSString *lineCap;
