...
@implementation UIBezierPath (GTKit)

+ (UIBezierPath *)gt_bezierPathWithText:(NSString *)text font:(UIFont *)font {
...
+ (CGRect)gt_maximumSquareFrameThatFits:(CGRect)frame;
{
    CGFloat a = MIN(frame.size.width, frame.size.height);
    return CGRectMake(frame.size.width/2 - a/2, frame.size.height/2 - a/2, a, a);
}

+ (UIBezierPath *)gt_heartShape:(CGRect)originalFrame
{
    CGRect frame = [self gt_maximumSquareFrameThatFits:originalFrame];
...
+ (UIBezierPath *)gt_userShape:(CGRect)originalFrame
{
    CGRect frame = [self gt_maximumSquareFrameThatFits:originalFrame];
...
+ (UIBezierPath *)gt_martiniShape:(CGRect)originalFrame
{
    CGRect frame = [self gt_maximumSquareFrameThatFits:originalFrame];
...
+ (UIBezierPath *)gt_beakerShape:(CGRect)originalFrame
{
    CGRect frame = [self gt_maximumSquareFrameThatFits:originalFrame];
...
+ (UIBezierPath *)gt_starShape:(CGRect)originalFrame
{
    CGRect frame = [self gt_maximumSquareFrameThatFits:originalFrame];
...
+ (UIBezierPath *)gt_stars:(NSUInteger)numberOfStars shapeInFrame:(CGRect)originalFrame
{
    ...
    for (int i=0; i < numberOfStars; i++) {
        // get the star shape
        UIBezierPath* startPath = [UIBezierPath gt_starShape:babyFrame];
