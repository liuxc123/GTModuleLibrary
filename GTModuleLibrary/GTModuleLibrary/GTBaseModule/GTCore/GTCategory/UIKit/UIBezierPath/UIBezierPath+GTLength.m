...
typedef struct GTBezierSubpath {
    CGPoint startPoint;
...
@implementation UIBezierPath (GTLength)
...
- (void)extractSubpaths:(GTBezierSubpath*)subpathArray
{
...
- (CGPoint)pointAtPercent:(CGFloat)t ofSubpath:(GTBezierSubpath)subpath {
...
- (CGFloat)gt_length {
	...
	GTBezierSubpath subpaths[subpathCount];
...
- (CGPoint)gt_pointAtPercentOfLength:(CGFloat)percent {
    ...
    GTBezierSubpath subpathContainingPoint;
	for (NSUInteger i = 0; i < subpathCount; i++) {
