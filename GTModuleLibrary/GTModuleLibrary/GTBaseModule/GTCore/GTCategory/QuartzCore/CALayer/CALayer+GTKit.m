...
- (UIViewContentMode)contentMode {
    return GTCAGravityToUIViewContentMode(self.contentsGravity);
}

- (void)setContentMode:(UIViewContentMode)contentMode {
    self.contentsGravity = GTUIViewContentModeToCAGravity(contentMode);
}

-(void)setGt_contentsUIImage:(UIImage*)bgImage{
    self.contents=(__bridge id)(bgImage.CGImage);
}
-(UIImage*)gt_contentsUIImage{
...
- (void)addFadeAnimationWithDuration:(NSTimeInterval)duration curve:(UIViewAnimationCurve)curve {
    ...
    [self addAnimation:transition forKey:@"gtkit.fade"];
}

- (void)removePreviousFadeAnimation {
    [self removeAnimationForKey:@"gtkit.fade"];
}
